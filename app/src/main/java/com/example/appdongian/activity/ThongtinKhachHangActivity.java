...
import com.example.appdongian.ultil.CheckConnection;
        ...
        btnxacnhan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ten.length() > 0 && sdt.length() > 0 && email.length() > 0){
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, server.Duongdandonhang, new Response.Listener<String>() {
                        ...
                        public void onResponse(final String madonhang) {
                            ...
                            if (Integer.parseInt(madonhang) > 0){
                                ...
                                StringRequest request = new StringRequest(Request.Method.POST, server.Duongdanchitietdh, new Response.Listener<String>() {
                                    @Override
                                    public void onResponse(String response) {
                                        if (response.equals("1")){
                                            ...
                                            CheckConnection.ShowToast_Short(getApplicationContext(), "Đã xảy ra lỗi dữ liệu giỏ hàng!");
                                        }
                                    }
                    ...
                    CheckConnection.ShowToast_Short(getApplicationContext(), "Bạn hãy kiểm tra lại dữ liệu còn thiếu!");
                }
            }
        });
    }
